...
-file ../../mapreduce-test-python/lab2/mapper.py -mapper ../../mapreduce-test-python/lab2/mapper.py \
-file ../../mapreduce-test-python/lab2/reducer.py -reducer ../../mapreduce-test-python/lab2/reducer.py \
-input /lab2/input/access.log -output /lab2/output/  -cmdenv FILTER_WORD="0-1"
